...
class NlosDataset(Dataset):
    ...
    def __init__(self, config, dataset_type, transforms=None):
    ...
    def laser_working(self, path, h):
        return np.transpose(cv2.imread(path)[:-h], (1, 0, 2))[:, ::-1]
    ...
    def __getitem__(self, index):
        ...
        #     laser_pool_01 = ThreadPool(len(laser_images_01))
        #     laser_pool_02 = ThreadPool(len(laser_images_02))
        ...
        #     try:
        #         laser_images_01 = laser_pool_01.map(partial(self.laser_working,h=h),laser_images_01) # parallelizing
        #         laser_images_02 = laser_pool_02.map(partial(self.laser_working,h=h),laser_images_02) # parallelizing
        #         laser_pool_01.close()
        #         laser_pool_01.join()
        #         laser_pool_02.close()
        #         laser_pool_02.close()
        ...
        #     return laser_image, targets
        # elif self.sensor == "laser_rf":
        #     features = torch.cat([laser_image, rf_data], dim=0)
        #     return features, targets
        # elif self.sensor == "laser_sound":
        #     features = torch.cat([laser_image, sound_data], dim=0)
        #     return features, targets
        # elif self.sensor == "laser_rf_sound":
        #     features = torch.cat([laser_image, rf_data, sound_data], dim=0)
        #     return features, targets
        # elif self.sensor == "rgb_image":
        #     return rgb_image, targets
        # else:
